...
function VideoPin({
  ...
  const pinClassname = useMemo(() => {
    ...
    // Special case for autogenerated pins where we want to pulse them when
    // they show up on the video
    if (metadata.autogenerated && openThread !== id) {
      return 'pin-on-video-pulse';
    }

    return 'pin-on-video';
  }, [displayOnControls, id, metadata, openThread]);
